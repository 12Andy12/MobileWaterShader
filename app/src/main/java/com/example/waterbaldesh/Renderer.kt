...
import com.example.waterbaldesh.ShaderUtils.createProgram
import com.example.waterbaldesh.ShaderUtils.createShader
import com.example.waterbaldesh.TextureUtils.loadTexture
...
//        eyeZ = (sin(angle) * 6f).toFloat();
    ...
    override fun onDrawFrame(arg0: GL10) {
        ...
        createViewMatrix();
        water.draw(mViewMatrix, mProjectionMatrix)
